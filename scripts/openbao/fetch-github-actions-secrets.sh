...
case "${1:-}" in
  bootstrap)
    ...
    emit_secret OBSERVABILITY_TIMEWEB_DBAAS_EXPORTER_USERNAME core-platform/observability OBSERVABILITY_TIMEWEB_DBAAS_EXPORTER_USERNAME
    emit_secret OBSERVABILITY_TIMEWEB_DBAAS_EXPORTER_PASSWORD core-platform/observability OBSERVABILITY_TIMEWEB_DBAAS_EXPORTER_PASSWORD
    ;;
  edge)
