...
- Keycloak for SSO.
- Grafana, VictoriaMetrics, VictoriaLogs, VictoriaTraces, vmalert, Alertmanager, node-exporter, OpenTelemetry Collector, and the owner-routed Telegram alert gateway for observability.
- OpenBao for secrets.
