...
worker_group_id="${CORE_PLATFORM_WORKER_GROUP_ID:-114537}"
worker_group_name="${CORE_PLATFORM_WORKER_GROUP_NAME:-core-platform-infrastructure}"
worker_group_node_count="${CORE_PLATFORM_WORKER_GROUP_NODE_COUNT:-2}"
worker_group_preset_id="${CORE_PLATFORM_WORKER_GROUP_PRESET_ID:-1685}"
